package com.myflexhero.network.core.ui
{
	 ...
	 * 550561954#qq.com 
	 */
	public class SmallNodeUI extends SmallElementUI
	{
		...
		public function SmallNodeUI(network:Network, value:IData)
		{
			super(network,value);
		...
		private function createNewBitmapData():void{
			...
			if(bitmapData==null){
				...
				if(totalPixel>16777215){
					bw = bw*(16770000/totalPixel);
					bh = bh*(16770000/totalPixel);
